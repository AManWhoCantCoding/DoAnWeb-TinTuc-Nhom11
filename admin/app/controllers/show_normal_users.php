...
class show_normal_users extends framework{
 ...
 public $results_per_page = 100;
  ...
  final public function index(){
      ...
      $data = [
        'count' => $this->auth->get_users_data(0,  $start_from, $results_per_page)['count'],
        'row'   => $this->auth->get_users_data(0,  $start_from, $results_per_page)['row']
      ];
